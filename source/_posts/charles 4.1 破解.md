...
{% fi http://image.msiter.com/charles-logo.png %}
...
{% fi http://image.msiter.com/charles-pro-3.png %}
...
{% fi http://image.msiter.com/charles-pro-4.png %}
...
{% fi http://image.msiter.com/charles-filter-setting.jpg %}

通常情况下，我们使用方法一做一些临时性的封包过滤，使用方法二做一些经常性的封包过滤。

方法三：在想过滤的网络请求上右击，选择 "Focus"，之后在 Filter 一栏勾选上 Focussed 一项，如下图所示：

{% fi http://image.msiter.com/charles-focus.png %}
...
{% fi http://image.msiter.com/charles-proxy-setting.jpg %}

### iPhone 上的设置

首先我们需要获取 Charles 运行所在电脑的 IP 地址，Charles 的顶部菜单的 "Help"->"Local IP Address"，即可在弹出的对话框中看到 IP 地址，如下图所示：

{% fi http://image.msiter.com/charles-local-ip.png %}
...
{% fi http://image.msiter.com/charles-iphone-setting.jpg %}

设置好之后，我们打开 iPhone 上的任意需要网络通讯的程序，就可以看到 Charles 弹出 iPhone 请求连接的确认菜单（如下图所示），点击 "Allow" 即可完成设置。

{% fi http://image.msiter.com/charles-proxy-confirm.jpg %}
...
{% fi http://image.msiter.com/charles-pro-2.png %}
...
{% fi http://image.msiter.com/charles-throttle-setting.jpg %}
...
{% fi http://image.msiter.com/charles-repeat-1.png %}

接着我们就可以在弹出的对话框中，选择打压的并发线程数以及打压次数，确定之后，即可开始打压。

{% fi http://image.msiter.com/charles-repeat-2.png %}
...
{% fi http://image.msiter.com/charles-map.png %}
...
{% fi http://image.msiter.com/charles-map-remote.png %}
...
{% fi http://image.msiter.com/charles-save-response.png %}


下图是一个示例，我将一个指定的网络请求通过 Map Local 功能映射到了本地的一个经过修改的文件中。

{% fi http://image.msiter.com/charles-map-local.png %}
...
{% fi http://image.msiter.com/charles-rewrite-1.jpeg %}

我们想试着直接修改网络返回值，将 tangqiaoboy 换成成 iosboy。于是我们启用 Rewrite 功能，然后设置如下的规则：

{% fi http://image.msiter.com/charles-rewrite-2.png %}

完成设置之后，我们就可以从 Charles 中看到，之后的 API 获得的昵称被自动 Rewrite 成了 iosboy，如下图所示：

{% fi http://image.msiter.com/charles-rewrite-3.png %}
...
{% fi http://image.msiter.com/charles-breakpoint.png %}
...
{% fi http://image.msiter.com/charles-reverse-proxy.jpg %}
